...
import RegisterImg from '../../assets/meat.svg'
    ...
    const onSubmit = async clientData => {
        try {
            ...
            if(status == 201 || status == 200){
                ...
                toast.error('E-mail ja cadastrado, faça login pra logar')
            } else {
                throw new Error()
            }
        } catch (err) {
        ...
        <Container>
            ...
            <ContainerItens>
                ...
                <form noValidate onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <Button type="submit" style={{ marginTop: 25, marginBotton: 25 }}>Sign Up</Button>
                </form>
